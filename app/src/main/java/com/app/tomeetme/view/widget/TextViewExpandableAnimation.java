...
public class TextViewExpandableAnimation extends LinearLayout
    ...
    private void initValue(Context context, AttributeSet attrs) {
        ...
        if (null == drawableShrink) {
            drawableShrink = ContextCompat.getDrawable(context, R.drawable.icon_arrow_up);
        }

        if (null == drawableExpand) {
            drawableExpand = ContextCompat.getDrawable(context, R.drawable.icon_arrow_down);
        }

        if (TextUtils.isEmpty(textShrink)) {
            textShrink = context.getString(R.string.less);
        }

        if (TextUtils.isEmpty(textExpand)) {
            textExpand = context.getString(R.string.more);
        }
