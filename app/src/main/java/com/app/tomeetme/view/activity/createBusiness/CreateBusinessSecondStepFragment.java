...
public class CreateBusinessSecondStepFragment extends Fragment implements Step {
    ...
    public static CreateBusinessSecondStepFragment newInstance(@LayoutRes int layoutResId) {
        Bundle args = new Bundle();
        args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId);
        CreateBusinessSecondStepFragment fragment = new CreateBusinessSecondStepFragment();
